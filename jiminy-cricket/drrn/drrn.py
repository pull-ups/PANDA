...
class DRRN_Agent:
    def __init__(self, args):
        ...
        if args.load_dir:
            print("Loading agent model from: ", args.load_dir)
    ...
    def act(self, states, poss_acts_tokenized, poss_acts, lm=None, eps=None, alpha=0, k=-1, argmax=False, cond_weight=0,
        ...
        #print("action annotation: ", cond_probs[0][idxs[0]].tolist())
        # print("in drrn.py, act_ids: ", act_ids)
        # print("in drrn.py, act_strings: ", act_strings)
        # print("in drrn.py, idxs: ", idxs)
        # print("in drrn.py, values: ", values)
        # print("in drrn.py, cond_probs: ", cond_probs)
